...
const WEEKLY_POOL = [
  { id:'pvp_5',    type:'pvp_win',        target:5,  desc:'Win 5 PvP battles',           emoji:'⚔️', rewards:{ gold:25000, crystals:150 } },
  { id:'pvp_10',   type:'pvp_win',        target:10, desc:'Win 10 PvP battles',           emoji:'⚔️', rewards:{ gold:60000, crystals:350 } },
  { id:'dung_3',   type:'dungeon_clear',  target:3,  desc:'Full-clear 3 dungeons',        emoji:'🏰', rewards:{ gold:40000, crystals:200, ticket:1 } },
  { id:'boss_3',   type:'boss_kill',      target:3,  desc:'Defeat 3 World Bosses',        emoji:'👹', rewards:{ gold:80000, crystals:400, ticket:2 } },
  { id:'streak_5', type:'daily_streak',   target:5,  desc:'Claim daily 5 days in a row',  emoji:'🔥', rewards:{ gold:30000, crystals:200 } },
  { id:'summon_20',type:'summon_pull',    target:20, desc:'Do 20 summon pulls',            emoji:'🎲', rewards:{ gold:20000, crystals:100, ticket:1 } },
  { id:'pvp_s',    type:'pvp_streak',     target:3,  desc:'Win 3 PvP battles in a row',   emoji:'🔥', rewards:{ gold:50000, crystals:300, ticket:1 } },
  { id:'gold_1m',  type:'earn_gold',      target:1000000, desc:'Earn 1M gold this week',  emoji:'💰', rewards:{ gold:100000, crystals:300 } },
];

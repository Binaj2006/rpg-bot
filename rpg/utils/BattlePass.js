...
function getFreeReward(lvl, isMilestone) {
  ...
  if (isMilestone) {
    const milestones = {
      ...
      10: { type:'crystals', value:50,     desc:'50 Crystals' },
      15: { type:'gold',     value:8000,   desc:'8,000 Gold' },
      20: { type:'crystals', value:100,    desc:'100 Crystals' },
      25: { type:'gold',     value:20000,  desc:'20,000 Gold' },
      30: { type:'crystals', value:200,    desc:'200 Crystals' },
      35: { type:'gold',     value:50000,  desc:'50,000 Gold' },
      40: { type:'crystals', value:300,    desc:'300 Crystals' },
...
function getPremiumReward(lvl, isMilestone) {
  ...
  if (lvl % 2 === 0) return { type:'gold',     value:5000, desc:'5,000 Gold' };
  return                    { type:'crystals', value:30,   desc:'30 Crystals' };
}
